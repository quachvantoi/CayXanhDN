    ...
    <div class="container d-flex justify-content-between align-items-center">
      ...
      <nav id="navbar" class="navbar">
        <ul>
          ...
          <li class="dropdown"><a class="active" href="#"><span>Quản lý</span> <i class="bi bi-chevron-down"></i></a>
            <ul>
              <li><a href="#">Xem thông tin nhân viên</a></li>
              <li><a class="active" href="XemThongBaoSuCo.php">Xem thông báo về sự cố cây</a></li>
        ...
        <tbody>
          <?php 
            include('ketnoi.php');
              $tv="select *
          FROM danhsachsuco
          INNER JOIN khachhang ON danhsachsuco.maKhachHang=khachhang.maKhachHang
          INNER JOIN chitietsuco ON danhsachsuco.maDanhSachSuCo=chitietsuco.maDanhSachSuCo
          INNER JOIN cay ON chitietsuco.maCay=cay.maCay
          INNER JOIN tuyenduong ON cay.maDuong=tuyenduong.maDuong;";
