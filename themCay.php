                ...
                <form action="luuThemCay.php" method="post" role="form">
                  <div class="row">
                    ...
                    <div class="col-md-4 form-group mt-3 mt-md-0">
                      ...
                      <select class="form-control" id="exampleFormControlSelect1" name="tencay">
                        <?php
                        include('ketnoi.php');
                        $maLoaiCay = $_POST['maloaicay'];
                        $_SESSION['maLoaiCay'] = $maLoaiCay;
                        $tv="select * from cay where maLoaiCay = '". $maLoaiCay ."'";
                        $tv_1=mysqli_query($connect,$tv);
                    ...
                    <a class="col-md-1" href="themMoiCay.php">Thêm mới</a>
                  </div>
                  <div class="row">
