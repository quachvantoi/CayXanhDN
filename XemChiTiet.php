            ...
            <div class="row">
              ...
              <div class="col-lg-8">
                <form action="luuSuaCay.php" method="post" role="form">
                  <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                      ...
                      <?php
                        include('ketnoi.php');
                        $maCay = $_GET['macay'];
                        $tv="select * from cay JOIN tuyenduong ON cay.maDuong= tuyenduong.maDuong where cay.maCay = '$maCay'";
                    ...
                    <div class="col-md-5 form-group mt-3 mt-md-0">
                      <input type="text" class="form-control" name="tencay" id="tencay" value="<?php echo $tv_2['tenCay']; ?>" readonly>
                    </div>
                  </div>
                  <div class="row">
                    <p class="col-md-2 text-sm-center mt-3"> Tình Trạng:</p>
                    <div class="col-md-4 form-group mt-3">
                      <input type="text" class="form-control" name="tinhtrang" id="tinhtrang" value="<?php echo $tv_2['tinhTrang']; ?>" readonly>
                    </div>
                    <p class="col-md-2 text-sm-center mt-3"> Mã Loại Cây:</p>
                    <div class="col-md-4 form-group mt-3">
                      <input type="text" class="form-control" name="tinhtrang" id="tinhtrang" value="<?php echo $tv_2['maLoaiCay']; ?>" readonly>
                    </div>
                  </div>
                  <div class="row">
                    <p class="col-md-2 text-sm-center mt-3"> Đặc điểm:</p>
                    <div class="col-md-10 form-group mt-3">
                      <textarea class="form-control" name="DacDiem" rows="5" readonly><?php echo $tv_2['dacDiem']; ?></textarea>
                    </div>
                  </div>
                  <div class="row">
                    <p class="col-md-2 text-sm-center  mt-3">Chiều Cao:</p>
                    <div class="col-md-2 form-group  mt-3">
                      <input type="text" name="chieucao" class="form-control" id="chieucao" value="<?php echo $tv_2['chieuCao']; ?>" readonly>
                    </div>
                    <p class="col-md-1 mt-3">cm</p>
                    <p class="col-md-2 text-sm-center  mt-3">Ngày Trồng:</p>
                    <div class="col-md-5 form-group  mt-3">
                      <input type="date" class="form-control" name="ngaytrong" id="ngaytrong" value="<?php echo substr($tv_2['ngayTrong'],0,10); ?>" readonly>
                    </div>
                  </div>
                  <div class="row mt-3">
                    <p class="col-md-2 text-sm-center">Đường kính thân:</p>
                    <div class="col-md-3 form-group">
                      <input type="text" name="dkthan" class="form-control" id="dkthan" value="<?php echo $tv_2['duongKinhThan']; ?>" readonly>
                    </div>
                    <p class="col-md-1 mt-3">cm</p>
                    <p class="col-md-2 text-sm-center">Đường kính tán:</p>
                    <div class="col-md-3 form-group">
                      <input type="text" class="form-control" name="dktan" id="dktan" value="<?php echo $tv_2['duongKinhTan']; ?>" readonly>
                    </div>
                    <p class="col-md-1 mt-3">cm</p>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-md-4 form-group">
                      <input type="text" name="kinhdo" class="form-control" id="kinhdo" value="<?php echo $tv_2['kinhDo']; ?>" readonly>
                    </div>
                    <p class="col-md-2 text-sm-center">Vĩ độ:</p>
                    <div class="col-md-4 form-group">
                      <input type="text" class="form-control" name="vido" id="vido" value="<?php echo $tv_2['viDo']; ?>" readonly>
                    </div>
                  </div>
                  <div class="row mt-3">
                    <p class="col-md-2 text-sm-center">Mã khu vực:</p>
                    <div class="col-md-5 form-group">
                      <input type="text" class="form-control" name="makhuvuc" id="vido" value="<?php echo $tv_2['maKhuVucQuanLy']." - Đường ". $tv_2['tenDuong']; ?>" readonly>
                    </div>
                    <p class="col-md-2 text-sm-center">Hình ảnh:</p>
                    <div class="col-md-3 form-group">
                      <input type="text" class="form-control" name="hinhanh" id="hinhanh" value="<?php echo $tv_2['hinhAnh']; ?>" readonly>
                    </div>
                  </div>
                  ...
                  <div class="text-center mt-3"><button name="form_click" type="submit" class="btn btn-primary"><a href="SuaCay.php?macay=<?php echo $tv_2['maCay']; ?>">Sửa thông tin</a></button></div>
                </form>
                <div class="text-center mt-3"><button name="form_click" type="submit" class="btn btn-primary"><a href="ThongKeCay.php?kinhdo=<?php echo $tv_2['kinhDo']."&vido=".$tv_2['viDo']; ?>">Xem thống kê cây đã từng trồng</a></button></div>
              </div>
