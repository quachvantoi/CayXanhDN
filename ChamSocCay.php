                  ...
                  <div class="row">
                    ...
                    <div class="col-md-3 form-group">
                      ...
                      <?php
                        ...
                        $tam = substr($tv_2['maCay'],1);
                        echo 'C'.$tam;
                      ?>
                      " readonly>
                    </div>
                    <p class="col-md-3 text-sm-center"> Chế độ chăm sóc:</p>
                    <div class="col-md-4 form-group mt-3 mt-md-0">
                      <select class="form-control" id="exampleFormControlSelect2" name="tinhtrang">
                        <option>Chăm sóc hàng ngày</option>
                        <option>Chăm sóc hàng tuần</option>
                        <option>Không cần chăm sóc</option>
                      </select>
                    </div>
                  </div>
                  <div class="row">
                    <p class="col-md-2 text-sm-center mt-3">Phân bón:</p>
                    ...
                    <p class="col-md-2 text-sm-center mt-3"> Tưới nước:</p>
                    <div class="col-md-3 form-group mt-3">
                      <input class="form-control" name="DacDiem" rows="5" placeholder="Số nước cần thiết" required></input>
                    </div>
                    <p class="col-md-1 form-group mt-3"> lít</p>
                  </div>
                  <div class="row">
                    <p class="col-md-2 text-sm-center mt-3">Ghi chú:</p>
                    <div class="col-md-10 form-group mt-3">
                      <textarea class="form-control" name="DacDiem" rows="9" placeholder="Ghi chú" required></textarea>
                    </div>
                  </div>
